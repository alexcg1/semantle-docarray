...
welcome_string = """
Welcome to DocArray-Semantle. In this game you have to guess the target word from a list of the 10,000 most common words in English. After each guess you'll get a distance (how far you are from the word) and the temperature (hot, warm, or cold).

- Type /hint to get a hint (generated by GPT)
- Type /answer to get the answer
- Type /quit or /exit to quit

Without further ado, on with the game!
"""
